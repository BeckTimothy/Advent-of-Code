...
function manhattanCalc(wireOne, wireTwo) {
	...
	for(j = 0; j < wireTwo.length; j++) {
		...
		wireBuilder(wireTwoPositionsMoved, wireTwoPos, wireTwoDirection, wireOnePos, wireTwoPos, wireTwoArr);
	}
...
function wireBuilder(positionsMoved, startingPoint, direction, wireOnePos, wireTwoPos, wireArr) {
